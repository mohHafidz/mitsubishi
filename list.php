...
$result = query("SELECT * FROM data_sementara");
?>
...
<header>
    ...
    <div class="position-sticky" data-aos="fade-right">
      <div class="list-group list-group-flush mx-3 mt-4" data-aos="fade-right">
        ...
        <a href="#" class="list-group-item list-group-item-action py-2 ripple active" data-aos="fade-right">
          <i class="fas fa-chart-pie fa-fw me-3"></i><span>List Reatime Work</span>
        </a>

        <a href="rekap.php" class="list-group-item list-group-item-action py-2 ripple" style="background-color: #87cefa" data-aos="fade-right">
  ...
  <nav id="main-navbar" class="navbar navbar-expand-lg navbar-light fixed-top" style="background-color:  #87cefa;">
    ...
    <div class="container-fluid">
      ...
      <ul class="navbar-nav ms-auto d-flex flex-row">
        ...
        <!-- Avatar -->
        <li class="nav-item time" style="padding-right: 30px; padding-top:15px" data-aos="fade-left">
  ...
  <h2 class='mb-3'>Real Time Work</h2>
